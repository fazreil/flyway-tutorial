...
<Split>
<Workflow src="
[<start> Current Workflow]Current Workflow--[All DCP DB maintenance job]
[All DCP DB maintenance job]->[Stop replication]
...
<Workflow src="
[<start> Proposed Workflow]Proposed Workflow--[All DCP DB maintenance job]
[All DCP DB maintenance job]->[Stop replication]
[Stop replication]->[Backup Kony Fabric databases]
[Backup Kony Fabric databases]->[BE BO backup script]
